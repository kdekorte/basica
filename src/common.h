...
typedef enum {
    ...
    TOKEN_OPEN, TOKEN_CLOSE, TOKEN_AS, TOKEN_NAME, TOKEN_INPUT, TOKEN_SEEK, TOKEN_DELETE, TOKEN_DATA, TOKEN_READ, TOKEN_RESTORE, TOKEN_RANDOMIZE, TOKEN_KILL, TOKEN_FILES, TOKEN_CHDIR, TOKEN_MKDIR, TOKEN_RMDIR, TOKEN_SHELL, TOKEN_ERASE, TOKEN_FIELD, TOKEN_LSET, TOKEN_RSET, TOKEN_LINE_INPUT, TOKEN_EOF_FUNC,
    TOKEN_DRAW, TOKEN_OPTION, TOKEN_BASE, TOKEN_WINDOW, TOKEN_VIEW,
    TOKEN_DEFINT, TOKEN_DEFSTR, TOKEN_DEFSNG, TOKEN_DEFDBL,
    TOKEN_USING, TOKEN_APOSTROPHE,
    TOKEN_PUT, TOKEN_GET, TOKEN_GETS,
    TOKEN_WHILE, TOKEN_WEND, TOKEN_KEY, TOKEN_INKEY, TOKEN_TIMER, TOKEN_STRIG,
    TOKEN_BEEP,
    ...
    TOKEN_SWAP, TOKEN_ON, TOKEN_OFF, TOKEN_ERR,
